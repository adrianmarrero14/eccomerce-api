...
class SendNewsletterCommand extends Command
{
    ...
    Correos Electronicos a los cuales enviar directamente {--s|schedule : 
    Si debe ser ejecutado directamente o no}';

    protected $description = 'Send newsletter to all users with verificated email';
    ...
    public function handle()
    {
        ...
        if ($userEmails) $builder->whereIn('email', $userEmails);
